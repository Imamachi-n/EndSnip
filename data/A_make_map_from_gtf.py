...
#Usage:
#python3 A_make_map_from_gtf.py <gtf file(.gtf)> <map file(.map)>

input_file = open(sys.args[1], 'r') #"/mnt/hgfs/Projects/EndClip/EndClip/data/gencode.v24.basic.annotation.gtf"
output_file = open(sys.argv[2], 'w') #"/mnt/hgfs/Projects/EndClip/EndClip/data/gencode.v24.basic.annotation.map"
